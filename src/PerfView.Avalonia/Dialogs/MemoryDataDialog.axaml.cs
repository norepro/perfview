...
namespace PerfView.Dialogs
{
    ...
    public partial class MemoryDataDialog : WindowBase
    {
        ...
        private void ProcessesMouseDoubleClick(object sender, RoutedEventArgs e)
        {
        ...
        private void DumpHeap(bool closeOnComplete)
        {
            ...
            {
                // TODO_AVALONIA: MessageBox not available in Avalonia - use custom dialog
