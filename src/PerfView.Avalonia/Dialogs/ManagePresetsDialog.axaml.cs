...
namespace PerfView.Dialogs
{
    ...
    public partial class ManagePresetsDialog : WindowBase
    {
        ...
        private void DoHyperlinkHelp(object sender, RoutedEventArgs e)
        {
            ...
            string helpTerm = "Preset";
            MainWindow.DisplayUsersGuide(helpTerm);
        }
        private void OKClicked(object sender, RoutedEventArgs e)
        {
            // TODO_AVALONIA: DialogResult not available, using Close(true) pattern
            Close(true);
        }
        private void SaveClicked(object sender, RoutedEventArgs e)
        {
            ...
            if (PresetName.Text != m_currentPreset)
            {
                ...
                {
                    // TODO_AVALONIA: MessageBox not available in Avalonia
                    XamlMessageBox.Show(
            ...
            // TODO_AVALONIA: ListBox.UnselectAll() → SelectedItem = null
        ...
        {
            // TODO_AVALONIA: Use StorageProvider.OpenFilePickerAsync()
