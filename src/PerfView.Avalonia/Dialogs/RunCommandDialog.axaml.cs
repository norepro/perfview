    ...
    public partial class RunCommandDialog : WindowBase
    {
        public RunCommandDialog(CommandLineArgs args, MainWindow mainWindow, bool isCollect = false, Action continuation = null) : base(mainWindow)
        {
            ...
            if (isCollect)
            {
                ...
                CommandToRunTextBox.IsVisible = false;
                CommandToRunLabel.IsEnabled = false;
                CommandToRunLabel.IsVisible = false;
                FocusProcessCheckBox.IsVisible = true;
                FocusProcessTextBox.IsVisible = true;
                FocusProcessLabel.IsVisible = true;
            ...
            {
                CommandToRunTextBox.IsVisible = true;
                CommandToRunLabel.IsVisible = true;
                FocusProcessCheckBox.IsVisible = false;
                FocusProcessTextBox.IsVisible = false;
                FocusProcessLabel.IsVisible = false;
        ...
        {
            // TODO_AVALONIA: Use StorageProvider.SaveFilePickerAsync()
        ...
        private void DoExpand(object sender, RoutedEventArgs e)
        {
            ...
            // TODO_AVALONIA: Measure/DesiredSize pattern may differ in Avalonia
        ...
        private void DoCpuCountersListBoxKey(object sender, KeyEventArgs e)
        {
            ...
            else if (e.Key == Key.Escape)
            {
                ...
                CpuCountersTextBox.Focus();
            }
        }
        private void DoCpuCountersListBoxDoubleClick(object sender, RoutedEventArgs e)
        {
            // TODO_AVALONIA: verify event args - was MouseButtonEventArgs
            UpdateCpuCounters();
        }
