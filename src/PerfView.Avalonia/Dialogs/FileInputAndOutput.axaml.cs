...
using System.IO;
using System.Linq;
// TODO_AVALONIA: System.Media.SystemSounds not available in Avalonia
using Avalonia;
...
namespace PerfView.Dialogs
{
    ...
    public partial class FileInputAndOutput : WindowBase
    {
        ...
        public new void Show()
        {
            ...
            {
                InstructionParagraph.Text = Instructions;
            }

            if (HelpAnchor == null)
            {
                HelpHyperlink.IsVisible = false;
        ...
        private void FilesDoubleClick(object sender, RoutedEventArgs e)
        {
            // TODO_AVALONIA: verify event args - was MouseButtonEventArgs, now using RoutedEventArgs for DoubleTapped
