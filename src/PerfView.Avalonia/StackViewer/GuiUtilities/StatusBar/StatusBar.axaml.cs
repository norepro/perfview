...
{
    /// <summary>
    /// Interaction logic for StatusBar.axaml
    /// </summary>
    public partial class StatusBar : UserControl, INotifyPropertyChanged
    {
        ...
        public void LogError(string errorMessage)
        {
            ...
            if (errorMessage.IndexOf('\n') < 0)     // Is it a one line error message?
            {
                if (Dispatcher.UIThread.CheckAccess())
                {
                    ...
                    Status = errorMessage;
                    // TODO_AVALONIA: RoutedEvent HighlightMessageEvent not ported; implement Avalonia equivalent if needed
                }
                else
                {
        ...
        // TODO_AVALONIA: RoutedEvent registration (HighlightMessageEvent) not available in Avalonia; use Avalonia's RoutedEvent<RoutedEventArgs> if needed
        // public static readonly RoutedEvent HighlightMessageEvent = ...
        ...
        public void OpenLog()
        {
            LogWriter.Flush();
            LogWindow.Show();
            // TODO_AVALONIA: ScrollToEnd equivalent for Avalonia TextBox
        ...
        public void StartWork(string message, Action work, Action finally_ = null)
        {
            ...
            {
                // TODO_AVALONIA: Helpers.AncestorOfType<Window> - find ancestor window
                m_parentWindow = this.FindAncestorOfType<Window>();
            }
