...
namespace PerfView
{
    ...
    public partial class TreeViewGrid : UserControl
    {
        public TreeViewGrid()
        {
            ...
            // TODO_AVALONIA: ClipboardContentBinding not available in Avalonia DataGrid
        ...
        public object SelectedNode
        {
            get
            {
                // TODO_AVALONIA: SelectedCells not available in Avalonia DataGrid, use SelectedItem instead
        ...
        private void Select(TreeViewGridNode item)
        {
            ...
            // TODO_AVALONIA: ItemContainerGenerator not available in Avalonia DataGrid
        ...
        private string PadForColumn(string content, int columnIndex)
        {
            ...
            if (maxString == 0)
            {
                ...
                // TODO_AVALONIA: SelectedCells iteration not available in Avalonia DataGrid
        ...
        // }
        private static string GetCellStringValue(Control contents)
        {
        ...
        // my context menu. 
        // TODO_AVALONIA: PreparingCellForEdit event not available in Avalonia DataGrid
